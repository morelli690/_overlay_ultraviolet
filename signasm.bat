...
sn.exe -R "Ultraviolet.Content.glTF2.dll" "%TLSN%"
...
sn.exe -R "Ultraviolet.ImGuiViewProvider.dll" "%TLSN%"
sn.exe -R "Ultraviolet.ImGuiViewProvider.Bindings.dll" "%TLSN%"
...
sn.exe -R "Ultraviolet.FreeType2.dll" "%TLSN%"
